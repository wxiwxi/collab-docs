...
export const ja: Dictionary = {
    slash_menu: {
        ...
        numbered_list: {
            ...
            aliases: ['ol', 'li', 'numberedlist', 'numbered list', 'リスト', '番号付リスト', '番号 リスト'],
            group: '基本ブロック',
        },
        bullet_list: {
            title: '箇条書き',
            subtext: '箇条書きを表示するために使用',
            aliases: ['ul', 'li', 'bulletlist', 'bullet list', 'リスト', '箇条書きリスト'],
            group: '基本ブロック',
        },
        check_list: {
            title: 'チェックリスト',
            subtext: 'チェックボックス付きリストを表示するために使用されます',
            aliases: ['ul', 'li', 'list', 'checklist', 'checked list', 'リスト', 'チェックリスト', 'チェックされたリスト'],
            group: '基本ブロック',
        },
        paragraph: {
            title: '標準テキスト',
        ...
        image: {
            title: '画像',
            subtext: '画像を挿入',
            aliases: ['image', 'imageUpload', 'upload', 'img', 'picture', 'media', 'url', '画像'],
            group: 'メディア',
        },
        video: {
            title: 'ビデオ',
            subtext: 'ビデオを挿入',
            aliases: ['video', 'videoUpload', 'upload', 'mp4', 'film', 'media', 'url', 'ビデオ'],
            group: 'メディア',
        },
        audio: {
            title: 'オーディオ',
            subtext: 'オーディオを挿入',
            aliases: ['audio', 'audioUpload', 'upload', 'mp3', 'sound', 'media', 'url', 'オーディオ'],
            group: 'メディア',
        },
        file: {
            title: 'ファイル',
