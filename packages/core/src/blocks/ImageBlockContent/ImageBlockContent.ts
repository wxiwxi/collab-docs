...
export const imageRender = (block: BlockFromConfig<typeof imageBlockConfig, any, any>, editor: WangxDocEditor<any, any, any>) => {
    ...
    image.alt = block.props.name || block.props.caption || 'WangxDoc image'
