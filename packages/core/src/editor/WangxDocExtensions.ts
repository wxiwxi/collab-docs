...
/**
 * Get all the Tiptap extensions WangxDoc is configured with by default
 */
export const getWangxDocExtensions = <BSchema extends BlockSchema, I extends InlineContentSchema, S extends StyleSchema>(opts: {
