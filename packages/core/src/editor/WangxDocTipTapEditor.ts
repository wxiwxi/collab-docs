...
export type WangxDocTipTapEditorOptions = Partial<Omit<EditorOptions, 'content'>> & {
 ...
 */
export class WangxDocTipTapEditor extends TiptapEditor {
    private _state: EditorState

    public static create = (options: WangxDocTipTapEditorOptions, styleSchema: StyleSchema) => {
        ...
        try {
            return new WangxDocTipTapEditor(options, styleSchema)
        } finally {
            if (oldSetTimeout) {
    ...
    protected constructor(options: WangxDocTipTapEditorOptions, styleSchema: StyleSchema) {
...
;(WangxDocTipTapEditor.prototype as any).createView = function () {
    // no-op
