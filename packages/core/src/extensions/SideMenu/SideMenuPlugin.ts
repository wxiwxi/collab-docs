...
export class SideMenuView<BSchema extends BlockSchema, I extends InlineContentSchema, S extends StyleSchema> implements PluginView {
    ...
    constructor(
        private readonly editor: WangxDocEditor<BSchema, I, S>,
    ...
    onDrop = (event: DragEvent) => {
        ...
        if ((event as any).synthetic || !event.dataTransfer?.types.includes('wangxdoc/html')) {
            return
        }
...
> extends EventEmitter<any> {
    ...
    constructor(private readonly editor: WangxDocEditor<BSchema, I, S>) {
        super()
