...
const PLUGIN_KEY = new PluginKey(`wangxdoc-placeholder`)

export const PlaceholderPlugin = (editor: WangxDocEditor<any, any, any>, placeholders: Record<string | 'default', string>) => {
    return new Plugin({
        key: PLUGIN_KEY,
        view: () => {
