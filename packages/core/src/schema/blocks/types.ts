...
export type WangxDocDOMElement = 'editor' | 'block' | 'blockGroup' | 'blockContent' | 'inlineContent'

export type WangxDocDOMAttributes = Partial<{
    [DOMElement in WangxDocDOMElement]: Record<string, string>
}>
