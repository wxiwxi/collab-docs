...
export type CustomBlockImplementation<T extends CustomBlockConfig, I extends InlineContentSchema, S extends StyleSchema> = {
    render: (
        ...
        /**
         * The WangxDoc editor instance
         * This is typed generically. If you want an editor with your custom schema, you need to
         * cast it manually, e.g.: `const e = editor as WangxDocEditor<typeof mySchema>;`
         */
        editor: WangxDocEditor<BlockSchemaWithBlock<T['type'], T>, I, S>
...
export function createBlockSpec<T extends CustomBlockConfig, I extends InlineContentSchema, S extends StyleSchema>(
    ...
    const node = createStronglyTypedTiptapNode({
        ...
        addNodeView() {
            return ({ getPos }) => {
                // Gets the WangxDoc editor instance
    ...
    if (node.name !== blockConfig.type) {
        throw new Error('Node name does not match block type. This is a bug in WangxDoc.')
    }
