...
function getBlockSelectionData(editor: WangxDocEditor<any, any, any>): BlockSelectionData {
...
function updateBlockSelectionFromData(editor: WangxDocEditor<any, any, any>, data: BlockSelectionData) {
...
export function moveBlockUp(editor: WangxDocEditor<any, any, any>) {
...
export function moveBlockDown(editor: WangxDocEditor<any, any, any>) {
    // This function currently only supports moving a single block.
    const editorSelection = editor.getSelection()
    if (editorSelection && editorSelection.blocks.length > 1) {
        return
