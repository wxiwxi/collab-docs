...
function fragmentToExternalHTML<BSchema extends BlockSchema, I extends InlineContentSchema, S extends StyleSchema>(
    ...
    if (isWithinTable) {
        ...
        // first convert selection to wangxdoc-style table content, and then
        ...
        // first convert selection to wangxdoc-style inline content, and then
        // pass this to the exporter
...
const copyToClipboard = <BSchema extends BlockSchema, I extends InlineContentSchema, S extends StyleSchema>(
    ...
    //  some reason.
    event.clipboardData!.setData('wangxdoc/html', clipboardHTML)
                    ...
                    props: {
                        handleDOMEvents: {
                            ...
                            dragstart(view, event) {
                                ...
                                // TODO: Writing to other MIME types not working in Safari for
                                //  some reason.
                                event.dataTransfer!.setData('wangxdoc/html', clipboardHTML)
