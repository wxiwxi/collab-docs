...
/**
 * Converts an internal (prosemirror) table node contentto a WangxDoc Tablecontent
 */
...
/**
 * Converts an internal (prosemirror) content node to a WangxDoc InlineContent array.
 */
export function contentNodeToInlineContent<I extends InlineContentSchema, S extends StyleSchema>(
    ...
    // while in WangxDoc links are a type of inline content
...
/**
 * Convert a TipTap node to a WangxDoc block.
 */
