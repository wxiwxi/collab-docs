...
import { BlockSchema, InlineContentSchema, StyleSchema, SuggestionMenuState } from '@wangx-doc/core'
    ...
    return (
        <div ref={ref} style={style} {...getFloatingProps()}>
            <GridSuggestionMenuWrapper
                ...
                columns={columns}
                gridSuggestionMenuComponent={gridSuggestionMenuComponent || GridSuggestionMenu}
